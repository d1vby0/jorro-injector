...
use Jorro\Injector\Resolve\UsingResolvePlugin;
use Jorro\Injector\ResolveAttributeAwareTrait;
...
class ResolvableInjectorTest extends TestCase
{
    ...
    #[DataProvider('injectorProvider')]
    public function testArgsUsingInjection($injector)
    {
